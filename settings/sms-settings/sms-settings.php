<?php
$sample_sms_msg = "Hi {attendee_name} !
...
register_setting('reminder-plugin-sms-settings','reminder_plugin_sms_message_format_setting');
add_option('reminder_plugin_sms_message_format_setting',$sample_sms_msg);
 add_settings_section(
        'reminder_plugin_sms_settings_section',
        'SMS Settings',
        'reminder_plugin_sms_settings_section_cb',
        'reminder-plugin-sms-settings'
    );
  add_settings_field(
        'reminder_plugin_sms_message_format_setting_field',
        'Sms Field',
        'reminder_plugin_sms_messgae_format_settings_field_cb',
        'reminder-plugin-sms-settings',
        'reminder_plugin_sms_settings_section',
    [
        'class' => 'sms_scope'
...
function reminder_plugin_sms_settings_section_cb(){
    ?>
    
    
   
    <?php
	echo "<h3>Here you can edit your SMS message which is to be sent as a Reminder Message</h3>";
}
function reminder_plugin_sms_messgae_format_settings_field_cb(){
	$sms_msg = get_option('reminder_plugin_sms_message_format_setting');	
    ?>
<div class="wrap">
            ...
            <div id="post-body-content">
                ...
                <div class="meta-box-sortables ui-sortable">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <textarea  name="reminder_plugin_sms_message_format_setting" cols="80" rows="25" class="large-text"><?php echo $sms_msg;  ?></textarea>
                        </div>
                        <!-- .inside -->
...
<script type="text/javascript">
    ...
    jQuery('.sms_scope').find('[scope=row]').hide();  
    });
</script>
    <?php
}
